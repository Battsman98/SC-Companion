...
def test_only_user_request_failures_trigger_hotfix_animation() -> None:
    ...
    assert 'src="/assets/app.js?v=20260917-reputation-save-v1-award-roles-v1-award-delete-v1"' in html
    assert 'href="/assets/styles.css?v=20260917-award-delete-v1"' in html

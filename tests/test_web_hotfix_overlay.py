...
def test_only_user_request_failures_trigger_hotfix_animation() -> None:
    ...
    assert 'src="/assets/app.js?v=20260917-reputation-save-v1-award-roles-v1-award-delete-v1-all-special-channels-v5-award-selection-v2-rep-panel-guide-v1-awards-layout-v3"' in html

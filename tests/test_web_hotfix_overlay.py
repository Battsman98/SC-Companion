...
def test_only_user_request_failures_trigger_hotfix_animation() -> None:
    ...
    assert 'src="/assets/app.js?v=20260917-activity-command-v7-award-panel-v2"' in html
    assert 'href="/assets/styles.css?v=20260916-progress-tracker-layout-v1-award-management-v2"' in html
